...
class TransferSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        if data['amount'] <= 0:
            raise serializers.ValidationError({'detail':"Sorry, amount must be greater than zero"})
        return data
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            raise serializers.ValidationError({ 'detail':"Sorry, the account number does not exist"})
        ...
        with transaction.atomic():
            ...
            send_fcm_notification(
                ...
                "EpsPay",
                f"You have received {amount} SDG from {sender_profile.user.first_name} {sender_profile.user.last_name}"
            )
